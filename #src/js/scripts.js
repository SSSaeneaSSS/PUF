...
window.onload = function () {
  ...
  const body = document.querySelector('body'),
    ...
    thanksCloseBtn = document.querySelector('.thanks-popup__close-btn'),
  ...
  overlay.addEventListener('click', function () {
    ...
    closeFormPopup();
    thanksPopup.classList.add('display-none');
    overlay.style.display = 'none';
    body.style.overflow = 'auto';
  });
  ...
  function openThanksPopup() {
    let userName = formPopup.querySelector('.form__user-name').value;
    closeFormPopup();
    thanksPopup.querySelector(
      '.thanks-popup__user-name'
    ).textContent = userName;
    thanksPopup.classList.remove('display-none');
  }
